...
validate_item <- function(filename) {
    valid_names <- list(
        learning_area = c('Deskriptivstatistik', 'Grundlagen der Inferenzstatistik', 'Wahrscheinlichkeit', 'Zusammenhangsma\U00DFe', 'Regression', 'Poweranalyse', 'Gruppenvergleiche'),
